...
type AddEditBorrowDataSlice = Slice<AddEditBorrowData, {
				modifyBorrowedBook: ( state: WritableDraft<AddEditBorrowData>, action: PayloadAction<{ id: number, value: BorrowedBookData }> ) => void;
...
const addEditBorrowDataSlice: AddEditBorrowDataSlice = createSlice( {
								...
								reducers: {
												...
												addBorrowedBook: ( state: WritableDraft<AddEditBorrowData>, action: PayloadAction<BookInstance> ) => {
																...
																if( !borrowedBook ){
																				state.borrowedBooks.push( {
																								...
																								bookInstance: action.payload, beforeBorrow: {}, afterBorrow: { status: "normal" }, borrowDateRange: {},
																				} );
																}
												},
												...
												setPropToBorrowedBook: <K extends Path<BorrowedBookData>>( state: WritableDraft<AddEditBorrowData>, { payload: { idBorrowedBookOrBookInstance, key, value } }: PayloadAction<{
																idBorrowedBookOrBookInstance: number,
																key: K, value: PathValue<BorrowedBookData, K>,
												}> ) => {
