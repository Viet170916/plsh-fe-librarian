...
import {Box, Button, LinearProgress, Typography, Modal, IconButton} from "@mui/material";
import {CloudUpload, PictureAsPdf, NavigateBefore, NavigateNext, Visibility} from "@mui/icons-material";
