...
export const appToaster = {
				success( message: React.ReactNode, position: ToastPosition = "top-right", duration: number = 2000 ){
								toast.message( () => (
												<Grid sx = { { background: color.WHITE, borderRadius: 4, width:"100%" } }>
				...
				info( message: React.ReactNode, position: ToastPosition = "top-right", duration: number = 10000 ){
								toast.message( () => (
												<Grid sx = { { background: color.WHITE, borderRadius: 4, width:"100%" } }>
				...
				custom( message: React.ReactNode, position: ToastPosition = "top-right", duration: number = 10000 ){
