        ...
        >
            ...
            <div className="box__description">
                <div className="box__description-container">
                    ...
                    <div
                        className="box__description-text">{message ?? "Có vẻ như chúng tôi không thể tìm thấy trang bạn đang tìm kiếm."}</div>
                </div>
                <NeumorphicButton fullWidth variant={"contained"} sx={{bgcolor: color.FOUR, color: color.LIGHT_TEXT}}
                                  onClick={() => router.back()}>{appStrings.GO_BACK}</NeumorphicButton>
            </div>
        </div>
    );
}
