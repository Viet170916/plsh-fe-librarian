...
import {Box, Button, CircularProgress, List, ListItem, Skeleton, Tooltip, Typography,} from "@mui/material";
        ...
        <Box sx={{width: "100%", position: "relative"}}>
            ...
            <Grid container spacing={3} justifyContent="start" alignItems="center">
                <Box sx={{display: "flex", alignItems: "center", gap: 1}}>
                    <StarRating value={book.rating ?? 5}/>
                    <Typography variant="body2" sx={{color: color.DARK_TEXT}}>
                        {book.rating ?? appStrings.book.DEFAULT_RATING}{" "}
                        {book.rating?appStrings.unit.RATING:""}
                    </Typography>
                </Box>
                <Grid size={12}>
                    <Typography variant="body2" sx={{color: color.DARK_TEXT}}>
