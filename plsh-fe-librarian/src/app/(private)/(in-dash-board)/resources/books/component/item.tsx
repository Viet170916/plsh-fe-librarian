...
export const BookCard = memo(({book, newBook}: { book: BookData, newBook?: boolean }) => {
    return (
        <Grid sx={{p: 2, bgcolor: color.WHITE, borderRadius: 3}} spacing={1} width={"100%"} container height={"100%"}>
