								...
								<TableRow key = { member.id }>
												...
												<TableCell>
																<Grid container spacing = { 1 }>
																				...
																				<Grid>
																								{ member.isVerified ? <Typography sx = { { color: color.COMFORT } }>{ appStrings.member.VERIFIED }</Typography> : <Typography sx = { { color: color.SERIOUS } }>{ appStrings.member.NOT_VERIFIED }</Typography> }
																				</Grid>
																</Grid>
												</TableCell>
												<TableCell>
